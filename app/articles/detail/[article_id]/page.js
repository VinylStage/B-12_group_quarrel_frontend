  ...
  return (
    <div class="wrapper">
        <div class="sh_container container" id="main">
                ...
                <header>
                    ...
                    <div className="sh_row sh_best_userinfo">
                        <div className="sh_p sh_row sh_best_user">
                            ...
                            <p className="sh_p">
                                <a href="#" className="sh_a">username</a>
                            </p>
                        </div>  
            ...
            <form>
                <div>
                    <textarea name="comm_content" placeholder="Comment" className="ha_input"
                        required></textarea>
                </div>
                <button type="submit" style={{margin: '20px 0px'}}>댓글 작성</button>
            </form>
                {/* 댓글 append */}
                <div className="sh_line" style={{marginBottom: '20px'}}></div>
                <p>comm_create_at</p>
                <div className="sh_icon sh_a sh_row" style={{float:'right'}}>
                    <button type="submit" className="sh_icon sh_a">Like</button>
                ...
                <div className="sh_p sh_row sh_best_user" style={{width:'900px'}}>
                    ...
                    <div style={{fontSize:'23px',textAlign:'center',marginLeft:'40px'}}>comm_content</div>
                </div>
                {/* 본인만 보이게 */}
                <div className="sh_row" style={{justifyContent: 'flex-end'}}>
                    <form method="post" action="#" className="sh_row button" style={{marginRight:'10px'}}>
